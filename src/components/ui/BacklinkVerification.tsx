...
export function BacklinkVerification({ projectName, githubUrl, onVerificationComplete }: BacklinkVerificationProps) {
  ...
  const embedCode = `[![Featured on OPEN_SRC.ME](https://opensrc.me/badge.svg)](https://opensrc.me/alternatives/${projectName.toLowerCase().replace(/[^a-z0-9]+/g, '-')})`;

  const htmlBadge = `<a href="https://opensrc.me/alternatives/${projectName.toLowerCase().replace(/[^a-z0-9]+/g, '-')}"><img src="https://opensrc.me/badge.svg" alt="Featured on OPEN_SRC.ME" /></a>`;
