    ...
    async function fetchData() {
      ...
      try {
        ...
        setFormData({
          ...
          discount_code: alternative.discount_code || '',
          discount_percentage: alternative.discount_percentage || '',
          discount_description: alternative.discount_description || '',
          discount_expires_at: alternative.discount_expires_at ? new Date(alternative.discount_expires_at).toISOString().split('T')[0] : '',
        });
