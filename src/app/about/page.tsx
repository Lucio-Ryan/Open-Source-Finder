...
export const metadata: Metadata = {
  title: 'About Us | OSS_Finder',
  description: 'Learn about OSS_Finder - our mission to help people discover the best open source alternatives to proprietary software.',
};
